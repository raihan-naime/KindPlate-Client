...
const FoodRequestTable = ({ req, setFoodRequest, foodRequest }) => {
    ...
    <tr key={req._id} className="hover:bg-gray-50 border-b">
      ...
      <td>
        <button
          ...
          class="group relative flex h-14 w-14 flex-col items-center justify-center overflow-hidden rounded-xl border-2 border-red-500 bg-red-400 hover:bg-red-600"
        >
          <svg
